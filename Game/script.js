...
for (var i = 0; i <9; i++) {
 	...
 	innerElement.setAttribute('y' , parseInt(i / 3).toString());//y это номер строкиб, x - номер столбца
 	element.appendChild(innerElement);
 	board.appendChild(element);
  } 
  document.getElementByClassName('button')[0].onclick = reset;
  ...
  */ 
  ...
  /**
  *Функцкия сброса параметров игры
  */
  function reset() {
      gamer1 = true, // Показывает, какой игрок сейчас ходит
      gameTable = [[null, null, null], [null, null, null], [null, null, null]], // Матрица игры
      nullCount = 9, // Кол-во оставшихся ходов
      winner = null;
      var table =document.getElementByClassName('inner-cell');
